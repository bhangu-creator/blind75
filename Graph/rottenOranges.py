...
#the intuation is very simple at each pass you have to look at 4 diff directions and justmark them as rotten and also store them in queue, meaning at each sec time just use all the rotten oranges and mark 4 direction rotten also
